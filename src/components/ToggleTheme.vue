<template>
  <div class="toggle">
    <button role="button" aria-label="Toggle dark/light" @click.prevent="openGitHub" class="toggle-theme">
      <g-image v-if="darkTheme" alt="Github image" src="~/assets/images/GitHub-Mark-Light-120px-plus.png" width="22" height="22" blur="5" />
      <g-image v-else alt="Github image" src="~/assets/images/GitHub-Mark-120px-plus.png" width="22" height="22" blur="5" />
    </button>
